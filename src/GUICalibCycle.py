...
from . import GUICalibCycleWindow as guicalibcwin
...
#  Class definition --
#---------------------
class GUICalibCycle ( QtWidgets.QWidget ) :
    ...
    def __init__ (self, parent=None, app=None) :
        ...
        self.titNWin  = QtWidgets.QLabel('Number of calibcycle plots:')

        self.butMenuNWin = QtWidgets.QPushButton(str(cp.confpars.calibcycleNWindows) + self.char_expand)
